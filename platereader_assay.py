...
def main():
    ...
    parser.add_argument("-i","--infiles",required=True,default=None,nargs="*")
    ...
    for fn in args.infiles:
        ...
        for sheet in data:
            timestr = sheet[convert(time_starting_column,time_starting_row)].value
            if not timestr is None:
                ...
                if t_start > 0:
                    ...
                    print("reading data from file '{}', sheet '{}': starttime = {}".format(fn,sheet.title,t_start),file=sys.stderr)
                    i = 0
